package cristian_sedano.cityworld.activitis;
...
import cristian_sedano.cityworld.adapters.CityAdapter;
import cristian_sedano.cityworld.models.City;
import io.realm.Realm;
import io.realm.RealmChangeListener;
import io.realm.RealmResults;

public class CityWorld extends AppCompatActivity implements RealmChangeListener<RealmResults<City>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CityWorld.this, AddEditCityActivity.class);
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Remove", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        deleteCity(position);
                        Toast.makeText(CityWorld.this, "It has been deleted successfully", Toast.LENGTH_SHORT).show();
                    }
                })
